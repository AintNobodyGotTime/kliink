...
ProjectItem.create(content:'This 7,500 sq. ft. school will have 15 rooms and will accommodate 300 children.', project_id:1, title:"First item")
ProjectItem.create(content:'The Rajendra Nagar slum is home to some of the poorest people in southern India. 60% of the children do not attend school full time and over 50% do not make it to high school.', project_id:1, title:"Second item")
ProjectItem.create(content:'What these children lack in resources they make up in perserverance. These kids are very hard working and often work long hours in construction and domestic service to pay, and sometimes in lieu of their schooling.', project_id:1, title:"Third Item")